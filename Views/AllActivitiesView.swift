...
struct AllActivitiesView: View {
    ...
    @State private var allActivities: [ClientHomeView.UserActivity] = []
        ...
        db.collection("user_activities")
            ...
            .getDocuments { snapshot, error in
                DispatchQueue.main.async {
                    ...
                    self.allActivities = documents.compactMap { document -> ClientHomeView.UserActivity? in
                        try? document.data(as: ClientHomeView.UserActivity.self)
                    }
                }
            }
    }
